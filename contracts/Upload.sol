...
contract Upload {
  ...
  mapping(address => mapping(string => bool)) userUploadedHashes;


  function add(address _user,string memory url) external {
      require(!userUploadedHashes[_user][url], "You have already uploaded this file.");
      value[_user].push(url);
      userUploadedHashes[_user][url] = true;
  }
